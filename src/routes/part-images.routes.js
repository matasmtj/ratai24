...
r.put('/parts/:partId/images/:imageId/main', requireAuth, requireRole('ADMIN'), setMainPartImage);
r.put('/parts/:partId/images/reorder', requireAuth, requireRole('ADMIN'), reorderPartImages);
